                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-check-flat">
                                                <label class="form-check-label">
                                                    <label class="switch"><input name="is_promotion"
                                ...
                                <div class="tab-pane fade" id="Specification" role="tabpanel">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                @php
                                                    $product_sale_option_meta = App\Models\ProductMeta::where('product_id', $product->id)
                                                        ->where('meta_key', 'product_sale_option')
                                                        ->first();
                                                        
                                                        
                                                    $meta_value = $product_sale_option_meta->meta_value ?? '';
                                                ...
                                                <select id="product_sale_option" name="product_sale_option"
                                                    ...
                                                    <option value="digital"
                                                        @if ($meta_value == 'digital') selected @endif>Digital
                                                    </option>
                                                    <option value="downloadable"
                                                        @if ($meta_value == 'downloadable') selected @endif>Downloadable
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                @if ($downloadable_file)
                                                    <p style="width: 100%;">
                                                        <a href="{{ '/storage/downloadable/' . $downloadable_file->meta_value }}">{{ $downloadable_file->meta_value }}</a>
                                                    </p>
                                                @endif
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    name="downloadable_file_url"
                                                    value="{{ $downloadable_file_url->meta_value ?? '' }}"
