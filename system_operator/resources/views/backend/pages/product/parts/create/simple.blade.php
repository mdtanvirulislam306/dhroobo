<div id="simple_product" class="row">
                        ...
                        <form class="form-sample" id="product_form" method="post"
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="General" role="tabpanel">
                                    ...
                                    {{--  <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Product Type <span class="required">*</span></label>
                              <div class="col-sm-9">
                                <select class="form-control" name="type_for_shipping" id="type_for_shipping">
                                  ...
                                  <option value="other">Other</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3" @if(Auth::user()->getRoleNames() == '["seller"]') style="display:none" @endif>
                                            <div class="form-check form-check-flat">
                                                <label class="form-check-label">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="category_id[]" class="selectpicker form-control"
                                                data-size="10" data-show-subtext="true" data-live-search="true"
                                                multiple>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" min="0" name="loyalty_point"
                                                        value="{{ old('loyalty_point') }}" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    @endif
