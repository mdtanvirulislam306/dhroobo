...
@section('content')
	<div class="grid-margin stretch-card">
	   	<div class="card">
	      	<div class="card-body"> 
	            ...
	            <span class="create_product_title">Products</span>
	        	</span>
	         	<a href="{{ asset('files') }}/sample-csv/product_import_sample.csv" class="btn btn-info float-right" title="Download Sample CSV">Product Sample CSV</a>
	      	</div>
	   	</div>
	</div>
   ...
   <div class="product_type_selector ">
      <div class="card">
         <div class="card-body">
            <form class="" method="post" action="{{ route('admin.import.product.store.csv') }}" enctype="multipart/form-data" >
              	@csrf
              	<div class="row">
	                <div class="col-md-12">
