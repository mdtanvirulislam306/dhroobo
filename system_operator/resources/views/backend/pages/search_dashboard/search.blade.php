...
@section('title', 'Search List - ' . config('concave.cnf_appname'))
@section('content')
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <span class="card-title">Dashboard > Settings > Search Dashboard > List</span>
                <a class="btn btn-success float-right" href="{{ route('admin.create.search.dashboard') }}">Create New
                    Search</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        function fetchData() {
            var table = jQuery('#dataTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.get.search.dashboard.index') }}",
                    type: 'GET',
                },
                aLengthMenu: [
