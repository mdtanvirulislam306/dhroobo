...
@section('title','Attribute Set Create - '.config('concave.cnf_appname'))
@section('content')
<div class="grid-margin stretch-card">
   <div class="card">
      <div class="card-body">
         <span class="card-title">Dashboard > Attribute > Create New Attribute Set</span>
...
<div class="row">
   <div class="col-12 grid-margin">
      <div class="card">
         <div class="card-body">
            <form class="form-sample" method="post" action="{{ route('admin.attribute-set.store')}}" enctype="multipart/form-data" >
               @csrf
               <div class="row">
                  <div class="col-md-6">
				  ...
				  <div class="col-md-6">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                           <input type="text" name="attribute_set_code" placeholder="Attribute Set Code" class="form-control" required />
                        </div>
                     </div>
                  </div>
                  <div class="col-md-12">
				...
				<div class="row">
                 ...
                 <div class="col-md-6">
                     ...
                     <div class="col-sm-8" style="background: #f3f3f3;">
                        <div class="dynamic_attributes sortable"></div>
                     </div>
                     </div>
               ...
               <div class="col-md-6"></div>
					...
					<div class="col-md-2">
						 <div class="form-group">
							<p class="text-right">
							   <button class="btn btn-primary" name="save" type="submit">Add Attribute Set</button>
							</p>
						 </div>
					</div>
				</div>
