...
@section('title','Role Create - '.config('concave.cnf_appname'))
@section('content')
<style>
...
<div class="grid-margin stretch-card">
	<div class="card">
		  <div class="card-body">
      <span class="card-title">Dashboard > User Roles > New Role</span>
      <a class="btn btn-success float-right" href="{{ route('roles.index')}}">View Roles List</a>
			...
			<div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                  <form class="form-sample" method="post" action="{{ route('roles.store')}}" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="col-sm-10">
                              <div class="form-check form-check-flat">
                                <label class="form-check-label" style="text-transform: capitalize;">
                                  <input type="checkbox" id="select_all" class="form-check-input">Select All<i class="input-helper"></i>
                                </label>
                              </div>
                          </div>
                        </div><hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                @foreach($permissionData as $permission)
                                    <div class="form-check form-check-flat">
                                      <label class="form-check-label" style="text-transform: capitalize;">
                                        <input name="permissions[]" type="checkbox"  class="form-check-input" value="{{$permission}}">{{ str_replace('.',' ',$permission) }}<i class="input-helper"></i>
                                      </label>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <p class="text-right">
                                <button class="btn btn-primary" name="save" type="submit">Add Role</button>
                            </p>
                          </div>
                        </div>
                    </form>
