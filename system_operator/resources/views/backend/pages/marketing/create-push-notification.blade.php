...
@section('content')
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <form class="form-sample" method="post" action="{{ route('admin.marketing.send.push.notification') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Notification Link<span
                                        style="color: #f00">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" name="link" placeholder="{{ env('APP_API_URL') }}"
                                        class="form-control" />
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            ...
                            data-input-name="image" data-input-type="single"
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Notification Body</label>
                                <div class="col-sm-8">
