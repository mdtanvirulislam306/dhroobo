...
@section('title','Create Pick Point - '.config('concave.cnf_appname'))

@section('content')
<div class="grid-margin stretch-card">
	<div class="card">
		  <div class="card-body">
      <span class="card-title">Dashboard > Settings > Create New Pick Point</span>
                    ...
                    <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <select class="form-control" @error('division_id') is-invalid @enderror name="division_id"  data-show-subtext="true" data-live-search="true" name="shop_division" id="division_id">
                               ...
                               {{-- <input type="text" name="shop_division" class="form-control" @error('name') is-invalid @enderror value="{{ old('division_id') }}" required  autocomplete="name" autofocus placeholder="Division" > --}}
                               @error('division_id')
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" @error('union_id') is-invalid @enderror name="union_id" value="{{ old('union_id') }}" data-show-subtext="true" data-live-search="true" id="union_id">
                                  <option value="" selected disabled>--Select Upazila First--</option>
                                </select>
                               {{-- <input type="text" name="upazila_id" class="form-control" @error('upazila_id') is-invalid @enderror value="{{ old('upazila_id') }}" required  autocomplete="name" autofocus placeholder="Area" > --}}
                               @error('union_id')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="post_code" value="{{ old('post_code') }}" placeholder="Postal Code" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="discount" value="{{ old('discount') }}" placeholder="Shipping Amount" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="phone" value="{{ old('phone') }}" placeholder="Mobile Number" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <p class="text-right">
                                <button class="btn btn-primary" name="save" type="submit">Add Pick Point</button>
                            </p>
                          </div>
                        </div>
                      </div>
