...
@section('content')
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <span class="card-title">Dashboard > Location > Division</span>
                <a class="btn btn-success float-right" href="{{ route('admin.location.division.create') }}">Create New
                    Division</a>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <tr>
              ...
              <td class="text-center">               
                ...
                <a class="text-success" href="{{ route('admin.location.division.edit',$d->id)}}"><i class="mdi mdi-pencil-box-outline"></i></a>
                @endif             
                @if (Auth::user()->can('location.delete'))
                <a class="text-danger delete_btn" data-url="{{ route('admin.location.division.delete',$d->id)}}" data-toggle="modal" data-target="#deleteModal" href="#"><i class="mdi mdi-delete"></i></a>
                @endif  
              </td>
            </tr>
        @endforeach --}}
    ...
    <script type="text/javascript">
        function fetchData() {
            ...
            var table = jQuery('#dataTable').DataTable({
                ...
                ajax: {
                    url: "{{ url('admin/location/division/get-division') }}",
                    type: 'GET',
                    // data: {
                    //     'filter_by': filter_by,
