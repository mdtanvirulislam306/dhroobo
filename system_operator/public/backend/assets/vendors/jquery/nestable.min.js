 ...
 !(function (t, e, s, i) {
    ...
    (a.prototype = {
        init: function () {
            ...
            o && (s.el[0].addEventListener("touchstart", i, !1), e.addEventListener("touchmove", a, !1), e.addEventListener("touchend", l, !1), e.addEventListener("touchcancel", l, !1)),
                s.el.on("mousedown", i),
                s.w.on("mousemove", a),
                s.w.on("mouseup", l);
        },
        ...
        dragStart: function (e) {
            ...
            this.placeEl.css("height", o.height()),
                (i.offsetX = void 0 !== e.offsetX ? e.offsetX : e.pageX - a.offset().left),
                (i.offsetY = void 0 !== e.offsetY ? e.offsetY : e.pageY - a.offset().top),
            ...
            for (l = 0; l < d.length; l++) (n = t(d[l]).parents(this.options.listNodeName).length) > this.dragDepth && (this.dragDepth = n);
        },
        dragStop: function (t) {
        ...
        dragMove: function (i) {
            ...
            h.dirAx !== r
                ...
                : ((h.distAxX += Math.abs(h.distX)), 0 !== h.dirX && h.dirX !== h.lastDirX && (h.distAxX = 0), (h.distAxY += Math.abs(h.distY)), 0 !== h.dirY && h.dirY !== h.lastDirY && (h.distAxY = 0)),
                (h.dirAx = r),
                h.dirAx &&
                    ...
                    h.distX > 0 &&
                        ...
                        this.placeEl.parents(d.listNodeName).length + this.dragDepth <= d.maxDepth &&
                            (a.length ? (a = n.children(d.listNodeName).last()).append(this.placeEl) : ((a = t("<" + d.listNodeName + "/>").addClass(d.listClass)).append(this.placeEl), n.append(a), this.setParent(n)))),
                    h.distX < 0 && (this.placeEl.next(d.itemNodeName).length || ((o = this.placeEl.parent()), this.placeEl.closest(d.itemNodeName).after(this.placeEl), o.children().length || this.unsetParent(o.parent()))));
            var p = !1;
            if (
                ...
                this.pointEl.hasClass(d.handleClass) && (this.pointEl = this.pointEl.parent(d.itemNodeName)),
            ...
            if (!h.dirAx || g || p) {
                ...
                (o = this.placeEl.parent()),
                    p ? ((a = t(s.createElement(d.listNodeName)).addClass(d.listClass)).append(this.placeEl), this.pointEl.replaceWith(a)) : f ? this.pointEl.before(this.placeEl) : this.pointEl.after(this.placeEl),
                    o.children().length || this.unsetParent(o.parent()),
                    this.dragRootEl.find(d.itemNodeName).length || this.dragRootEl.append('<div class="' + d.emptyClass + '"/>'),
        ...
        (t.fn.nestable = function (e) {
            ...
            return (
                this.each(function () {
                    ...
                    i ? "string" == typeof e && "function" == typeof i[e] && (s = i[e]()) : (t(this).data("nestable", new a(this, e)), t(this).data("nestable-id", new Date().getTime()));
                }),
                s || this
            );
        });
