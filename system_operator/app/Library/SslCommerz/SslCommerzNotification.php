...
//                    }
    ...
    {
        $this->successUrl = env('APP_FRONTEND'). $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = env('APP_FRONTEND'). $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = env('APP_FRONTEND'). $this->config['cancel_url'];
    }
